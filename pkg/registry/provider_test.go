...
func TestProviderMerge(t *testing.T) {
	...
	if gpt4.APIs.ChatCompletion.Parameters.Temperature == nil || *gpt4.APIs.ChatCompletion.Parameters.Temperature != 0.7 {
		t.Errorf("Expected temperature to remain 0.7, got %v", gpt4.APIs.ChatCompletion.Parameters.Temperature)
	}

	if gpt4.APIs.ChatCompletion.Parameters.MaxTokens == nil || *gpt4.APIs.ChatCompletion.Parameters.MaxTokens != 1000 {
...
func TestChatCompletionMerge(t *testing.T) {
	...
	if base.Parameters.Temperature == nil || *base.Parameters.Temperature != 0.5 {
	...
	if base.Parameters.MaxTokens == nil || *base.Parameters.MaxTokens != 1000 {
